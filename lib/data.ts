...
export const consultingOffers: Service[] = [
  ...
  },
  {
    id: "strategy",
    title: {
      [Language.EN]: "Strategic Discovery Call",
      [Language.FR]: "Session de Découverte Stratégique",
    },
    price: 60,
    duration: 30,
    category: "strategy",
    description: {
      [Language.EN]: "A focused 30-minute consultation designed to understand your goals, evaluate technical and business requirements, and identify the most effective strategy for your project. Ideal for startups, organizations, and businesses seeking expert guidance before committing to a larger engagement.",
      [Language.FR]: "Une consultation ciblée de 30 minutes conçue pour comprendre vos objectifs, analyser vos besoins techniques et métiers, et définir la stratégie la plus adaptée à votre projet. Idéale pour les startups, les entreprises et les institutions souhaitant bénéficier d'un accompagnement expert avant de s'engager dans une collaboration plus importante.",
    },
    features: {
      [Language.EN]: [
